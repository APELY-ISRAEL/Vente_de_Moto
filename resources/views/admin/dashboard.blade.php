    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <span class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Motos <sup>2</sup></div>
            </span>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Gestion de moto</h6>
                        <a class="collapse-item" href="{{ route('admin.ajout')}}">Ajouter une Moto</a>
                        <a class="collapse-item" href="{{ route('admin.liste') }}">Liste de Moto</a>
                        <a class="collapse-item" href="{{ route('admin.listevente') }}">Liste de Vente</a>
                    </div>
                </div>
            </li>
